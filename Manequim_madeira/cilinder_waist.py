...
circle1 = create_circle(radius_1_x, radius_1_y, -distance_between_spheres/2 + 60 , num_segments)
circle2 = create_circle(radius_2_x,radius_2_y,  distance_between_spheres/2  + 60, num_segments)
...
with open("waist.ply", "w") as ply_file:
    ply_file.write("ply\n")
...
print("Arquivo PLY 'waist.ply' foi gerado.")