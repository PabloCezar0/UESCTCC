...
circle1 = create_circle(radius_1_x, radius_1_y, -distance_between_spheres/2 + 8, num_segments)
circle2 = create_circle(radius_2_x,radius_2_y,  distance_between_spheres/2 + 8, num_segments)
...
with open("cilinder_rightArm.ply", "w") as ply_file:
    ply_file.write("ply\n")
...
print("Arquivo PLY 'cilinder_rightArm.ply' foi gerado.")