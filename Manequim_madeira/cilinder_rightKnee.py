...
def create_circle(radius_x, radius_y,z, num_segments):
    ...
    for i in range(num_segments):
        ...
        y = radius_y * math.sin(angle) + 16
        circle_vertices.append((x, y, z))
    return circle_vertices


circle1 = create_circle(radius_1_x, radius_1_y, -distance_between_spheres/2 + 188, num_segments)
circle2 = create_circle(radius_2_x,radius_2_y,  distance_between_spheres/2 + 188, num_segments)
...
with open("cilinder_rightKnee.ply", "w") as ply_file:
    ply_file.write("ply\n")
...
print("Arquivo PLY 'cilinder_rightKnee.ply' foi gerado.")