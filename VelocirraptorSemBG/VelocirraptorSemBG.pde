  ...
  pushMatrix();//neck articulation 
    ...
    pushMatrix();
     ...
     pushMatrix();//upper-jaw
        stroke(0);
        line(0,0,0,60,0,0);
        image(images[53],-840, -80);
     popMatrix();//end-upper-jaw
     pushMatrix();//lower-jaw
        stroke(0);
        line(0,0,0,50,30,0);
        image(images[54],-840, -75);
     popMatrix();//end-lower-jaw
    pushMatrix();//neck
      stroke(0);
      line(0,0,0,-150,75,0);
      image(images[52],-840, -80);
      image(images[51],-840, -80);
      image(images[50],-840, -80);
      image(images[49],-840, -80);
      image(images[48],-840, -80);
      image(images[47],-840, -80);
      pushMatrix();//front-spine-articulation
        ...
        pushMatrix();//front-spine
          stroke(0);
          line(0,0,0,-75,10,0);
          image(images[22],-540, -180);
          image(images[21],-540, -180);
          image(images[20],-540, -180);
          image(images[19],-540, -180);
          image(images[18],-540, -180);
          pushMatrix();//left-front
            ...
            pushMatrix();//left-forearm-articulation
              ...
              pushMatrix();//left-forearm
                stroke(0);
                line(0,0,0,50,70,0);
                image(images[55],-700, -120);
                image(images[56],-700, -120);
                  ...
                  pushMatrix();//left-arm1
                    ...
                    pushMatrix();//left-arm2-articulation
                      ...
                      pushMatrix();//left-arm2
                        stroke(0);
                        line(0,0,0,50,-10,0);
                        image(images[58],-725, -250);
                        image(images[59],-725, -250);
          ...
          pushMatrix();//back-spine-articulation
            ...
            pushMatrix();//back-spine
              stroke(0);
              line(0,0,0,-43,10,0);
              image(images[17],-465, -190);
              image(images[16],-465, -190);
              image(images[15],-465, -190);
                    ...
                    pushMatrix();
                      ...
                      rotateZ(tail1Z);
                        pushMatrix();//tail-image1
                          translate(0,-40,0);
                          rotateZ(-0.3);
                          image(images[0], -230, -175);
                          image(images[1], -230, -175);
                          image(images[2], -230, -175);
                          image(images[3], -230, -175);
                        popMatrix();
                    pushMatrix();//tail2;
                      stroke(0);
                      line(0,0,0,-200,10,0);   
                      image(images[4], -225, -210);
                      image(images[5], -225, -210);
                      image(images[6], -225, -210);
                      image(images[7], -225, -210);
                      image(images[8], -225, -210);
                      image(images[9], -225, -210);
                      image(images[9], -210, -210);
                      image(images[10], -225, -210);
                      image(images[11], -225, -210);
                      image(images[12], -225, -210);
                      image(images[13], -225, -210);
                      image(images[14], -225, -210);
                    popMatrix();//end-tail2
                ...
                pushMatrix();//left-back
                  ...
                  pushMatrix();//left-leg-articulation
                    ...
                    pushMatrix();//left-leg
                      stroke(0);
                      line(0,0,0,50,120,0);
                      image(images[23],-585, -165);
                      image(images[24],-585, -165);
