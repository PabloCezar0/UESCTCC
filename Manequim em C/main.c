...
int main() {
    ...
    create_cylinder("cilinder_leftArm.ply", 50, 10.0, 8.5, 10.0, 7.5, 52.0, 0.0, -42.0, 8.0);
	create_cylinder("cilinder_leftForeArm.ply", 50, 10.0, 7.5, 10.0, 7.8, 60.0, 0.0, -42.0, 70.0);
	...
	create_cylinder("cilinder_rightArm.ply", 50, 10.0, 8.5, 10.0, 7.5, 52.0, 0.0, 42.0, 8.0);
	create_cylinder("cilinder_rightForeArm.ply", 50, 10.0, 7.5, 10.0, 7.8, 60.0, 0.0, 42.0, 70.0);
	...
	create_sphere("articulation_leftArm.ply", 50, 10.0, 12.0, 8.0, 0.0, -42.0, -24.0);
	create_sphere("articulation_leftForeArm.ply", 50, 10.0, 7.5, 7.5, 0.0, -42.0, 37.0);
	create_sphere("articulation_leftHand.ply", 50, 7.5, 7.5, 7.5, 0.0, -42.0, 103.0);
	...
	create_sphere("articulation_rightArm.ply", 50, 10.0, 12.0, 8.0, 0.0, 42.0, -24.0);
	create_sphere("articulation_rightForeArm.ply", 50, 10.0, 7.5, 7.5, 0.0, 42.0, 37.0);
	create_sphere("articulation_rightHand.ply", 50, 7.5, 7.5, 7.5, 0.0, 42.0, 103.0);
